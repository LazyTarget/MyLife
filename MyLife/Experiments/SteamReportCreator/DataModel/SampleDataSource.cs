...
namespace SteamReportCreator.Data
{
    /// <summary>
    ...
    public sealed class SampleDataSource
    {
        ...
        public static async Task<IEnumerable<SampleDataGroup>> GetGroupsAsync()
        {
            try
            {
                ...
                //    ID = "12",
                //    Name = "My test report",
                //    Description = "This report will collect some Steam specific events, into one",
                //    StartTime = now.AddDays(-15),
                //    EndTime = now.AddDays(15),
                //};
                //reportRequest.Filters.Add(new SteamReportFilter
                //{
                //    GroupID = 1,
                //    GroupRule = FilterGroupRule.AND,
                //    Attribute = SteamReportAttribute.UserID,
                //    Operator = FilterOperator.Equals,
                //    Value = 76561197994923014,
                //});
                //reportRequest.Filters.Add(new SteamReportFilter
                //{
                //    GroupID = 1,
                //    GroupRule = FilterGroupRule.AND,
                //    Attribute = SteamReportAttribute.GameID,
                //    Operator = FilterOperator.Equals,
                //    Value = "730",
                //});
