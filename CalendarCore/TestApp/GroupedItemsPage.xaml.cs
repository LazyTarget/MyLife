...
namespace TestApp
{
    ...
    {
        private ICalendarServer _calendarServer;
        ...
        {
            if (e.NavigationParameter is ICalendarServer)
            {
                _calendarServer = (ICalendarServer)e.NavigationParameter;

                var calendars = await _calendarServer.GetCalendars();
