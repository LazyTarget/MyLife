...
namespace TestApp
{
    ...
    public sealed partial class WebBrowser : Page
    {
        ...
        private AuthEventArgs _authArgs;
        private AuthorizationNeededEventArgs _authNeededArgs;
        ...
        {
            _authNeededArgs = e;
            WebView.Navigate(new Uri(e.LoginUrl));
        }

        private void WebView_OnNavigationCompleted(WebView sender, WebViewNavigationCompletedEventArgs e)
        {
